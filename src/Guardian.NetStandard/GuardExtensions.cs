...
internal static class GuardExtensions
{
    ...
    public static void NullOrEmpty<T>(this Guard guard, Expression<Func<IEnumerable<T>>> expression)
    {
        Guard.Against.Null(expression);

        if (!expression.Compile().Invoke().Any())
        {
    ...
    [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification = "May not be called.")]
    [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "guard", Justification = "By design.")]
    public static void NullOrEmptyOrNullElements<T>(this Guard guard, Expression<Func<IEnumerable<T>>> expression)
        where T : class
    {
        Guard.Against.NullOrEmpty(expression);

        if (expression.Compile().Invoke().Any(element => element == null))
        {
        ...
        where T : struct
    {
        ...
        if (expression.Compile().Invoke().Any(element => !element.HasValue))
        {
            throw new ArgumentException("Value cannot contain null elements.", Guard.Expression.Parse(expression));
        }
    }
    ...
    [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification = "May not be called.")]
    [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "guard", Justification = "By design.")]
    public static void Positive(this Guard guard, Expression<Func<int>> expression)
    {
    ...
    [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification = "May not be called.")]
    [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "guard", Justification = "By design.")]
    public static void PositiveOrZero(this Guard guard, Expression<Func<int>> expression)
    {
    ...
    [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification = "May not be called.")]
    [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "guard", Justification = "By design.")]
    public static void Positive(this Guard guard, Expression<Func<long>> expression)
    {
        Guard.Against.OutOfRange(expression, value => value > 0, "Value cannot be positive.");
    }
    ...
    [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification = "May not be called.")]
    [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "guard", Justification = "By design.")]
    public static void PositiveOrZero(this Guard guard, Expression<Func<long>> expression)
    {
        Guard.Against.OutOfRange(expression, value => value >= 0, "Value cannot be positive or zero.");
    }
    ...
    [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification = "May not be called.")]
    [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "guard", Justification = "By design.")]
    public static void Negative(this Guard guard, Expression<Func<int>> expression)
    {
    ...
    [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification = "May not be called.")]
    [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "guard", Justification = "By design.")]
    public static void NegativeOrZero(this Guard guard, Expression<Func<int>> expression)
    {
    ...
    [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification = "May not be called.")]
    [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "guard", Justification = "By design.")]
    public static void Negative(this Guard guard, Expression<Func<long>> expression)
    {
        Guard.Against.OutOfRange(expression, value => value < 0, "Value cannot be negative.");
    }
    ...
    [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification = "May not be called.")]
    [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "guard", Justification = "By design.")]
    public static void NegativeOrZero(this Guard guard, Expression<Func<long>> expression)
    {
        Guard.Against.OutOfRange(expression, value => value <= 0, "Value cannot be negative or zero.");
    }
    ...
    [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification = "May not be called.")]
    [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "guard", Justification = "By design.")]
    public static void NullOrRelative(this Guard guard, Expression<Func<Uri>> expression)
    {
        Guard.Against.Null(expression);

        if (!expression.Compile().Invoke().IsAbsoluteUri)
        {
    ...
    [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification = "May not be called.")]
    [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "guard", Justification = "By design.")]
    public static void NullOrAbsolute(this Guard guard, Expression<Func<Uri>> expression)
    {
        Guard.Against.Null(expression);
    ...
    [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification = "May not be called.")]
    [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "guard", Justification = "By design.")]
    public static void Empty(this Guard guard, Expression<Func<Guid>> expression)
    {
        Guard.Against.Invalid(expression);
        Guard.Against.Null(() => expression);

        if (expression.Compile().Invoke() == Guid.Empty)
        {
            throw new ArgumentException("Value cannot be empty.", Guard.Expression.Parse(expression));
        }
    }
    ...
    private static void OutOfRange<T>(this Guard guard, Expression<Func<T>> expression, Func<T, bool> rangePredicate, string errorMessage)
    {
        Guard.Against.Invalid(expression);
        Guard.Against.Null(() => expression);
